...
void Lsl::calcConditions(CPSR_t& cpsr,
...
void Lsr::calcConditions(CPSR_t& cpsr,
                         const uint32_t result,
                         const uint32_t sourceValue,
                         const uint32_t shiftAmount)
{
...
void Asr::calcConditions(CPSR_t& cpsr,
                         const uint32_t result,
                         const uint32_t sourceValue,
                         const uint32_t shiftAmount)
{
...
uint32_t Asr::shift(const uint32_t sourceValue, const uint32_t shiftAmount)
{
    ...
    return static_cast<int64_t>(static_cast<int32_t>(sourceValue)) >>
        maskedShift;
}

void Ror::calcConditions(CPSR_t& cpsr,
                         const uint32_t result,
                         const uint32_t sourceValue,
                         const uint32_t shiftAmount)
{
...
uint32_t Ror::shift(const uint32_t sourceValue, const uint32_t shiftAmount)
{
    ...
    return (sourceValue >> effectiveShift) |
        (sourceValue << (32 - effectiveShift));
}

void Rrx::calcConditions(CPSR_t& cpsr,
                         const uint32_t result,
                         const uint32_t sourceValue,
                         const uint32_t shiftAmount)
{
