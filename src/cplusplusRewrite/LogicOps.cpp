...
void LogicOp::execute(uint32_t& destinationRegister, uint32_t operand1,
RotatorUnits& rotation, bool setConditions) { uint32_t operand2 =
rotation.calculate(setConditions); calculate(destinationRegister, operand1,
operand2, setConditions); if (setConditions) calcConditions(operand1, operand2);
}
...
void And::calculate(uint32_t& destinationRegister, uint32_t operand1, uint32_t
operand2, bool setConditions)
{
...
void Or::calculate(uint32_t& destinationRegister, uint32_t operand1, uint32_t
operand2, bool setConditions)
{
    destinationRegister = operand1 | operand2;
}
...
void Xor::calculate(uint32_t& destinationRegister, uint32_t operand1, uint32_t
operand2, bool setConditions)
{
    destinationRegister = operand1 ^ operand2;
}
...
void Tst::calculate(uint32_t& destinationRegister, uint32_t operand1, uint32_t
operand2, bool setConditions)
{
    if (!setConditions)
...
void Mrs::calculate(uint32_t& destinationRegister, uint32_t operand1, uint32_t
operand2, bool setConditions)
{
    if (specialBit)
...
void Msr::calculate(uint32_t& destinationRegister, uint32_t operand1, uint32_t
operand2, bool setConditions)
{
    if (!setConditions)
        destinationRegister = m_cpsr.val;
...
void Cmp::calculate(uint32_t& destinationRegister, uint32_t operand1, uint32_t
operand2, bool setConditions)
{
...
void Cmn::calculate(uint32_t& destinationRegister, uint32_t operand1, uint32_t
operand2, bool setConditions)
{
}
...
void Teq::calculate(uint32_t& destinationRegister, uint32_t operand1, uint32_t
operand2, bool setConditions)
{
    if (!setConditions) {
...
void Mov::calculate(uint32_t& destinationRegister, uint32_t operand1, uint32_t
operand2, bool setConditions)
{
...
void Bic::calculate(uint32_t& destinationRegister, uint32_t operand1, uint32_t
operand2, bool setConditions)
{
    destinationRegister = operand1 & ~operand2;
}
...
void Mvn::calculate(uint32_t& destinationRegister, uint32_t operand1, uint32_t
operand2, bool setConditions)
{
    destinationRegister = ~operand2;
}
