...
static constexpr SingleDataTransfer_t fromOpcode(const uint32_t opcode)
{
    ...
    return {.offset = static_cast<uint32_t>(opcode & 0xFFF),
...
static auto disassemble(const uint32_t opcode)
{
    ...
    return std::format("{}{}{} R{}, [R{}{}{}{}{}", ls, bw, condition,
                       op.destinationRegister, op.baseRegister, prePost1,
                       makeExpression(opcode), prePost2, writeback);
}
} // namespace SingleDataTransfer
