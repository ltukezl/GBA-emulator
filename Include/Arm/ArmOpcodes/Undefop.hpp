...
public:
    ...
    static constexpr uint32_t mask(const uint32_t opcode) { return 0; }
    ...
    static constexpr UndefOpOpcode fromOpcode(const uint32_t opcode)
    {
        return {
            ...
            .unsused2 =
                static_cast<uint32_t>((opcode >> 5) & 0xFFFFF), // bits 5�24
            .reserved2 =
    ...
    static auto disassemble(const uint32_t opcode) { return "Undefined"; }
};
