...
class DataProcessingImmediate
{
public:
    struct DataProcessingImmediateOpcode
    {
    ...
    static constexpr DataProcessingImmediateOpcode
    fromOpcode(const uint32_t opcode)
    {
        return {
    ...
    static constexpr bool isThisOpcode(const uint32_t opcode)
    {
        ...
        return (opcodeStruct.reserved == 1);
    }
    ...
    static void execute(Registers& regs, const uint32_t opcode)
    {
        ...
        switch (c_op.operation) {
            case 0:
                operand2 =
                    ImmediateRotater::calculate(regs, opcode, op.set_sign);
                result =
            ...
            case 2:
                ...
                break;
            case 3:
                operand2 = ImmediateRotater::calculate(regs, opcode, 0);
                result =
            ...
            case 7: // RSC
                ...
                break;
            case 8:
                operand2 = ImmediateRotater::calculate(regs, opcode, 1);
                result =
            ...
            case 10:
                operand2 =
                    ImmediateRotater::calculate(regs, opcode, 1); // don't care
                result =
