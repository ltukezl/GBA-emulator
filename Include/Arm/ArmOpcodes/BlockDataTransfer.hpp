...
public:
    ...
    static constexpr BlockDataTransferOpcode fromOpcode(const uint32_t opcode)
    {
        return {
            ...
            .baseReg =
                static_cast<uint32_t>((opcode >> 16) & 0xF), // bits 16�19
            ...
            .reserved =
                static_cast<uint32_t>((opcode >> 25) & 0x7), // bits 25�27
            .condition =
                static_cast<uint32_t>((opcode >> 28) & 0xF) // bits 28�31
        };
    }
    ...
    static inline void empty_rlist_bug_ldm(Registers& regs,
                                           const BlockDataTransferOpcode op)
    {
    ...
    static inline void empty_rlist_bug_stm(Registers& regs,
                                           const BlockDataTransferOpcode op)
    {
        regs[op.baseReg] -= 0x40;
    ...
    static auto disassemble(const uint32_t opcode)
    {
        ...
        const auto increment =
            op.addOffset ? 'I' : 'D'; // Increment / Decrement
        ...
        return std::format("{}{}{}{} R{}{}, {{{}}}{}", opcodeName, increment,
                           preIncrement, condition, baseReg, writeback, rlist,
                           load_psr);
    }
