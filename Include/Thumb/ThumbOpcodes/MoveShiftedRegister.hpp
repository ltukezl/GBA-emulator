...
public:
    ...
    static constexpr std::array m_shifts{shifts::Lsl::shift, shifts::Lsr::shift,
                                         shifts::Asr::shift};
    static constexpr std::array m_conditions{shifts::Lsl::calcConditions,
    ...
    static constexpr MoveShiftedRegisterOpcode fromOpcode(const uint16_t opcode)
    {
        return {
            ...
            .immediate =
                static_cast<uint16_t>((opcode >> 6) & 0b11111), // bits 6–10
            .instruction =
                static_cast<uint16_t>((opcode >> 11) & 0b11), // bits 11–12
            .unused =
                static_cast<uint16_t>((opcode >> 13) & 0b111) // bits 13–15
        };
    }
    ...
    static auto disassemble(const uint16_t opcode)
    {
        ...
        return std::format("{} R{}, R{}, #0x{:x}", operation, op.destination,
                           op.source, value);
    }
};
