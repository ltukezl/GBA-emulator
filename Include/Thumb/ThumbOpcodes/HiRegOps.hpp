...
public:
    ...
    static constexpr std::array mathOps_arr{
        mathOps::Add::calculate, mathOps::Cmp::calculate,
        mathOps::Mov::calculate, mathOps::Mov::calculate};
    ...
    static constexpr HighRegOpsOpcode fromOpcode(const uint16_t opcode)
    {
        return {
            ...
            .instruction =
                static_cast<uint16_t>((opcode >> 8) & 0x0003), // bits 8–9
            .reserved =
                static_cast<uint16_t>((opcode >> 10) & 0x003F) // bits 10–15
        };
    }
    ...
    static auto disassemble(const uint16_t opcode)
    {
        ...
        return std::format("{} {}, {}", mathOps_arr_s[op.instruction], reg1,
                           reg2);
    }
};
