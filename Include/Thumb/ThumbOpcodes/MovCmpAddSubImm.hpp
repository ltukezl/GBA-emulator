...
public:
    ...
    static constexpr std::array m_maths{
        mathOps::Mov::calculate, mathOps::Cmp::calculate,
        mathOps::Add::calculate, mathOps::Sub::calculate};
    static constexpr std::array m_conditions{
        mathOps::Mov::calcConditions, mathOps::Cmp::calcConditions,
        mathOps::Add::calcConditions, mathOps::Sub::calcConditions};
    ...
    static constexpr MovCmpAddSubImmOpcode fromOpcode(const uint16_t opcode)
    {
        return {
            ...
            .destination =
                static_cast<uint16_t>((opcode >> 8) & 0x7), // bits 8–10
            .instruction =
                static_cast<uint16_t>((opcode >> 11) & 0x3),      // bits 11–12
