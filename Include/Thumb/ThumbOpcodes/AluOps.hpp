...
public:
    static constexpr std::array conditionFunctions = {
        ...
        shifts::Asr::calcConditions,  mathOps::Adc::calcConditions,
        mathOps::Sbc::calcConditions, shifts::Ror::calcConditions,
        mathOps::Tst::calcConditions, mathOps::Neg::calcConditions,
        mathOps::Cmp::calcConditions, mathOps::Cmn::calcConditions,
        mathOps::Orr::calcConditions, mathOps::Mul::calcConditions,
    ...
    {
        return {.destination = static_cast<uint16_t>(opcode & 0b111),
    ...
    static void execute(Registers& regs, const uint16_t opcode)
    {
        ...
        switch (c_op.instruction) {
            ...
            case 1:
                ...
                break;
            case 2:
                result = shifts::Lsl::shift(operand1, operand2);
                dest = result;
                break;
            case 3:
                result = shifts::Lsr::shift(operand1, operand2);
                dest = result;
                break;
            case 4:
                result = shifts::Asr::shift(operand1, operand2);
                dest = result;
                break;
            case 5:
                result =
            ...
            case 6:
                ...
                break;
            case 7:
                result = shifts::Ror::shift(operand1, operand2);
                dest = result;
                break;
            case 8:
                result =
                ...
                break; // no writeback
            case 9:
                result = mathOps::Neg::calculate(regs.m_cpsr, 0, operand2);
                dest = result;
                break;
            case 10:
                result =
            ...
            case 13:
                result =
                    mathOps::Mul::calculate(regs.m_cpsr, operand1, operand2);
                dest = result;
                break;
            case 14:
                result =
        ...
        conditionFunctions[c_op.instruction](regs.m_cpsr, result, operand1,
                                             operand2);
    }
